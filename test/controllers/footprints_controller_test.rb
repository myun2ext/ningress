...
class FootprintsControllerTest < ActionController::TestCase
  ...
  test "should create footprint" do
    assert_difference('Footprint.count') do
      post :create, footprint: { latitude: @footprint.latitude, longitude: @footprint.longitude, user_id: @footprint.user_id }
    end
  ...
  test "should update footprint" do
    patch :update, id: @footprint, footprint: { latitude: @footprint.latitude, longitude: @footprint.longitude, user_id: @footprint.user_id }
    assert_redirected_to footprint_path(assigns(:footprint))
  end
